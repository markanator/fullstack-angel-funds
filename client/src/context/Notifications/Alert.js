...
export default function Alert({ type, text, onClose }) {
  ...
  return (
    <motion.div
      className={`container bg-${color}-500 flex items-center text-white text-sm font-bold px-4 py-3 relative m-auto`}
      id="alertbox"
    ...
    >
      ...
      <button
        type="button"
        onClick={onClose}
        className="absolute top-0 bottom-0 right-0 px-4 py-3 closealertbutton"
      >
        <svg
